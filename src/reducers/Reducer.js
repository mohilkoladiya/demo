import {
    ...
    COMMENT_REQUEST, COMMENT_SUCCESS, COMMENT_ERROR,
    LIKE_REQUEST, LIKE_SUCCESS, LIKE_ERROR,
    DISLIKE_REQUEST, DISLIKE_SUCCESS, DISLIKE_ERROR
} from '../action/Action'
...
import {
    ...
    contactus, activePost, comment, like, disLike
} from './State'
...
export const commentReducer = (state = comment, action) => {
    switch (action.type) {
        ...
        case COMMENT_SUCCESS: return {
            ...state,
            loading: false,
            data: action.payload
        }
        case COMMENT_ERROR: return {
            ...state,
            loading: false,
            data: [],
            error: action.payload
